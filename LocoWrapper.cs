...
public class LocoWrapper: IEquatable<LocoWrapper>
{
    ...
    public float Brake
    {
        get => _brakePort.Value;
        set => _brakePort.Value = value;
    }
    ...
    {
        get => _indBrakePort.Value;
        set => _indBrakePort.Value = value;
    }
    ...
    {
        get => _reverserPort.Value;
        set => _reverserPort.Value = value;
    }
    ...
    public float Sander
    {
        get => _sanderPort.Value;
        set => _sanderPort.Value = value;
    }

    public float Throttle
    {
        get => _throttlePort.Value;
        set => _throttlePort.Value = value;
    }
    ...
    public float DynBrake
    {
        get
        {
            if (_dynBrakePort != null) return _dynBrakePort.Value;
            return -1;
        }
        set
        {
            if (_dynBrakePort != null) _dynBrakePort.Value = value;
        }
    }
